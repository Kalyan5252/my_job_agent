...
const EnvSchema = z.object({
  ...
  OPENROUTER_MODEL_JOB_SCORING: z.string().default("google/gemma-4-31b"),
  OPENROUTER_MODEL_JOB_DECISION: z.string().default("google/gemma-4-31b"),
  OPENROUTER_MODEL_FORM_UNDERSTANDING: z.string().default("google/gemma-4-31b"),
  OPENROUTER_MODEL_FIELD_MAPPING: z.string().default("google/gemma-4-31b"),
  OPENROUTER_MODEL_ANSWER_GENERATION: z.string().default("google/gemma-4-31b"),
  OPENROUTER_MODEL_EMAIL_PARSING: z.string().default("google/gemma-4-31b"),
  OPENROUTER_MODEL_STATUS_CLASSIFICATION: z.string().default("google/gemma-4-31b"),
  OPENROUTER_MODEL_SCRAPER: z.string().default("google/gemma-4-31b"),
